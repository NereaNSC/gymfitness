...
// Para que cualquier usuario no pueda acceder al archivo del plugin
if(!defined('ABSPATH')) die();

// Función para Registrar un nuevo Post Type como CLASES
function gymfitness_clases_post_type() {
	...
	$args = array(
		...
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail' ), //Que quieres habilitar de todas las opciones o recursos de Wordpress
		'hierarchical'          => true, // true = posts , false = paginas  //Tipo de conportamiento en relacion al orden
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
        'menu_position'         => 6,
